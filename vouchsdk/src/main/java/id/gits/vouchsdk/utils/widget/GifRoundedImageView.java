package id.gits.vouchsdk.utils.widget;
 ...
 * Bandung, on 2019-09-13
 */
public class GifRoundedImageView extends GifImageView {
    ...
    public GifRoundedImageView(Context context) {
        super(context);
    }

    public GifRoundedImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GifRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
